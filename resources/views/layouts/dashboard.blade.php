...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link text-center">
      <span class="brand-text font-weight-bold">PT.<br>INTERINDODUTA TEKNO</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if (Session::get('id_akses')===1 or Session::get('id_akses')===3 or Session::get('id_akses')===4 or Session::get('id_akses')===5)
            <li class="nav-item has-treeview">
          ...
          @endif
           <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/report/terimabarang" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Terima Barang</p>
                </a>
                <a href="/report/pr" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>VR</p>
                </a>
              </li>
